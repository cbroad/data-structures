...
import { RedBlackTree, RedBlackTreeNode } from "@/Implementations/BinaryTrees";

import type { OrderedMapParameters } from "@/Types";
...
export class TreeMap<K, V> extends AbstractMap<K, V> {
    ...
    constructor(params: OrderedMapParameters<K, V> = {}) {
        super();
        this.#tree = new RedBlackTree<MapEntry<K, V>>({
            ...params,
            allowDupes: false,
            overWriteDupes: true,
